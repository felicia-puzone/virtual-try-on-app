...
% ??? Questo paragrafo è da sistemare
...
% ??? Non so se aggiungere tutte le references dirette. Non so se va bene così o è necessario scendere maggiormente nel dettaglio.
...
% ??? aggiustare, non sono ancora del tutto soddisfatto
...
\end{itemize}
% ??? articolo Cucchiara su Stable-Diffusion
...
% ??? dovrei inserire qualche citazione?
